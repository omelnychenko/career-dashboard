...
CASES = [
    ...
    dict(name="app_iso_currency", base="application",
         edits=[("salary_currency: EUR", "salary_currency: PLN")],
         expect=None, count=0),
    dict(name="app_bad_currency_code", base="application",
         edits=[("salary_currency: EUR", "salary_currency: Euro")],
         expect="salary_currency: 'Euro' is not a three-letter uppercase currency code",
         count=1),
